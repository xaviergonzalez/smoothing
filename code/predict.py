...
parser.add_argument("--hidden_size", type=int, default=444, help="size of hidden layer for mlp")
...
if __name__ == "__main__":
    ...
    base_classifier = get_architecture(checkpoint["arch"], args.dataset, noise_std = args.noise_std_lst, hidden_size = args.hidden_size)
